...
class EventView : BaseView {
    ...
    func configure(with eventViewModel: EventViewModel) {
        ...
        homeTeam.configure(teamLogoUrl: eventViewModel.homeTeamLogoURL,
                           teamName: eventViewModel.homeTeamName, textColor: eventViewModel.homeTeamTextColor)
        awayTeam.configure(teamLogoUrl: eventViewModel.awayTeamLogoURL,
                           teamName: eventViewModel.awayTeamName, textColor: eventViewModel.awayTeamTextColor)
        timeView.configure(matchTime: eventViewModel.matchStartTime, statusText: eventViewModel.matchStatusText, statusTextColor: eventViewModel.timeTextColor)
    }
